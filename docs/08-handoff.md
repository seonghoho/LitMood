...
| [#5 기록 수정·삭제 UI](https://github.com/seonghoho/LitMood/issues/5) | 한 콘텐츠는 한 번만 기록 가능한데 수정 수단이 없어, 오타 하나도 못 고칩니다 |
| [#3 프로필 편집](https://github.com/seonghoho/LitMood/issues/3)       | 가입 후 닉네임·소개를 바꿀 방법이 전혀 없습니다                             |
...
| [#4 orval 코드젠](https://github.com/seonghoho/LitMood/issues/4)       | 손으로 쓴 타입 때문에 이미 버그가 한 번 났습니다 |
| [#6 소비 맥락 입력](https://github.com/seonghoho/LitMood/issues/6)     | 차별점의 절반(맥락)이 입력 불가 상태입니다       |
...
2. **orval 생성 산출물을 커밋할 것인가** (#4) — 커밋 쪽을 권합니다 (CI 없이 빌드 가능, 계약 변경이 diff 로 보임)
...
- **프론트엔드 자동 테스트가 0건입니다.** 브라우저로 수동 확인만 했습니다 ([이슈 #9](https://github.com/seonghoho/LitMood/issues/9))
